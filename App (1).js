  ...
  return (
    <Tab.Navigator
      screenOptions={({ route }) => ({
        ...
        tabBarActiveTintColor: web ? '#fff' : '#0F766E',
        tabBarInactiveTintColor: '#5B6472',
        tabBarLabelPosition: web ? 'beside-icon' : 'below-icon',
        tabBarStyle: web ? styles.sidebarWeb : undefined,
        tabBarItemStyle: web ? styles.sidebarItemWeb : undefined,
        tabBarActiveBackgroundColor: web ? '#0F766E' : undefined,
